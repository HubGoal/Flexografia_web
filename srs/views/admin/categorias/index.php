                ...
                <tbody>
                    <?php foreach($categorias as $categoria){ ?>
                        <tr> 
                            ...
                            <td>
                                <a class="btn btn-warning btn-sm" href="edita.php?id=<?php echo $categoria['id'];?>">Editar</a>
                            </td>
                            <td>
...
>
    ...
    >
        <div class="modal-content">
            ...
            <div class="modal-body">¿Esta seguro que desea borrar la categoria?</div>
